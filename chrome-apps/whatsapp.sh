...
if [[ "$SESSION_TYPE" == "wayland" ]]; then
    ...
    google-chrome-stable --enable-features=UseOzonePlatform --ozone-platform=wayland --force-device-scale-factor=1.5 --user-data-dir=$HOME/.config/google-chrome-stable-for-whatsapp/ --app=https://web.whatsapp.com
else
